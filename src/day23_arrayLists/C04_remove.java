...
public class C04_remove {
    public static void main(String[] args) {
        ...
        urunler.remove(0); // bu sekilde atamis olduk silinen urunu dondurmez
        System.out.println(urunler); //[Cay] sadece bunu dondurur.
        // olmayan bir indexi silmeye calisirsak ? urunler.remove(1) desem simdi hata verir
