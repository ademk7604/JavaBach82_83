...
public class HA160 extends FMercedes{
    /*
         ...
         Parent'i olan tum class'daki abstract method'lari concrete hale donusturmek (override etmek) ZORUNDADIR
         Bu kuralin istisnasi; parent class'lardan herhangi birinde concrete hale donusturulmus, abstract method'lardir
         */
    public static void main(String[] args) {
        HA160 arb1= new HA160(); // concrete bir class'dan istedigimiz objeyi uretebiliriz
        ...
        Data turunu istedigimiz abstract class. Constructor'i ise child'i olan concrete bir class'dan seceriz
         */
    }
}
