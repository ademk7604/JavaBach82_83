...
public class ReusableMethods { // youtube deki proje olustur videosunu calisabilirsiniz
    public static Map<Integer, String> mapOlustur() {
        Map<Integer, String> sinifMap = new HashMap<>(); // map ile ugrasiyorsak sabirli olmaliyiz
        sinifMap.put(101, "Ali, Can, JDev");
        sinifMap.put(102, "Enes, Cem, Tester");
        sinifMap.put(103, "Taha, Emre, JDev");
        sinifMap.put(104, "Derya, Deniz, Dewops");
        sinifMap.put(105, "Enes, Can, Tester");
        sinifMap.put(106, "Tahaa, Deniz, Tester");
    ...
    public static void bransOgrencisayisiYazdir(Map<Integer, String> sinifListMap) { // brans=bransdakiOgrenciSayisi
