...
public class JavaMathClassMethods {
    ...
    public static void main(String[] args) {
        ...
        double doubleSayi = Math.random()*100;// 100= o ile 100 arasinda bana bir sayi uret// math dauble kullanir.
        System.out.println("doubleSayi = " + doubleSayi);

        /* int değerler üretme */
        int intSayi = (int) (Math.random()*100); // kusurattan kurtuluyoz
        ...
        // bu iki method dan birinden istedigini kullanabilirsin//
