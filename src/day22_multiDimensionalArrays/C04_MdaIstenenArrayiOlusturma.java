...
public class C04_MdaIstenenArrayiOlusturma {
    public static void main(String[] args) {
       ...
       ic array'larindaki tum elemanlarin toplamini birer birer bulan
       ve herbir sonucu yeni bir arrayin elemai yapan
       ve yeni erray i ekrana yazdiran bir program yaziniz
