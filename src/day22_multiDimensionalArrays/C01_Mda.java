...
public class C01_Mda {
    public static void main(String[] args) {
           ...
           /* tek katli arraylerde array i direk yazdiramiyoruz
            ...
            her nan primitive data direk yazdiralamayabilir
            ...
            ulasmak istedigimiz elementin bir array mi yoksa primitive data mi olgusudur.
         */
       ...
       /*
        ...
        1- elemanlari direk yazdirabiliriz
        int[][] sayilar={{1,2,3,4,5},{3,4}};
        2- outer ve inner array larin uzunluklari belirterek olusturabiliriz.
        int [][] sayilar=new int[3][4];
        ancak 2. yontem ile yaptigimizda inner array lerin farkli uzunlukta olma ihtimali kalmaz
