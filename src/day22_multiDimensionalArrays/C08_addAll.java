...
public class C08_addAll {
    public static void main(String[] args) {
        ...
        // demekki bir listenin (colleksion) icine veya sonuna baska bir liste ekleyebiliyoruz.
        // bir listenin sonuna veya istedigimiz bir indeksine baska bir collection ekleyebiliriz
