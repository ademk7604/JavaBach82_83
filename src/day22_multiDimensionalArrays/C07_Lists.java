...
public class C07_Lists {
    public static void main(String[] args) {
        ...
        List<Integer> sayilar= new ArrayList<>(); // primitive data turlerini kabul etmez. I ile ile yazdik
          /*
        ...
        // add methodu eski elementleri silmez veya update etmez, yeni element ekler, kaykil der.
