...
public class C03_TekrarEdenSayilar {
    public static void main(String[] args) {
        // soru1 verilen bir array daki tekrar eden elementleri yazdirim.
        ...
        for (int i = 0; i < arr.length-1 ; i++) {
            ...
            if(arr[i]==arr[i+1] && !tekrarEdenler.contains(arr[i])){ // yanindakilere esit ise ve yanindakiler arasinda yoksa
