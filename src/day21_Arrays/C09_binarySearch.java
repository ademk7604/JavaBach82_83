...
public class C09_binarySearch {
    public static void main(String[] args) {
      ...
      */
        ...
        System.out.println(Arrays.binarySearch(sayilar,11)); // -5 burda sira saydik olsaydi su sirada olurdu
        System.out.println(Arrays.binarySearch(sayilar,6)); // -3
        System.out.println(Arrays.binarySearch(sayilar,-100)); // -1 0 dan once -1 baslar o yuzden
