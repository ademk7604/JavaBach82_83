...
public class C01_InstanceVariables {
    ...
    public static void main(String[] args) {
         ...
         */
        C01_InstanceVariables obje1 = new C01_InstanceVariables(); //static olmayan bir method da olusturulmus veriable ye obje olusturarak ulasabiliyorum.
        ...
        System.out.println("obje2 degismeden once : "+obje2.instSayi); // 20 // her yeni objede veriable ya atadigim ilk degeri alir\\
        obje2.instSayi=25;
        ...
        /*
         Her obje olustugunda instance (obje) variable'inin ilk atanan degerini alir..obje2 ve 3 deki gibi.
         */
    }
