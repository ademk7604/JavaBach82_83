...
public class C03_LinkedList {
    public static void main(String[] args) {
        ...
        LinkedList<String> ll1=new LinkedList(); // linkedlist bunlarin child e  dir daha cok yetkisi vardir.
        ...
        System.out.println(ll2.remove(3)); // 3. indexdeki eleemnt ucus remive ayse silindi
        // eger listemiz integer elementlerden olusuyoirsa
        ...
        System.out.println(ll2.hashCode()); //2066939 referans kodu dur.
        ll2.add("Fatih");
