...
public class Isci extends Personel{
    ...
    bu durumda yeniden o variable ve methodlari olusturmak yerine  personel class ini kendimize parent ediniriz.(is yukumu %60 azalttim.)
    ...
    3- parent class da olmayan bazi yeni ozellikler olusturabilir.(yani veriable veya method)
    ...
    public static void main(String[] args) {
        ...
        // extends kelimesi sildigimde isci kirmizi oluyor// Isim belirtilmed
        ...
        // burdaki veaibale yi kullandi once kendi evimize baktik yoksa babaminkisi garanti orda vardir.
    ...
    public void ozelSigorta (){
        System.out.println("Iscilerden isteyene yuzde 50 indirim yapilir");
    }
}
