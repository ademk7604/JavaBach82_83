...
public class Kamyon {
    ...
    public Kamyon(String marka, String model, int yil, int fiyat) {
        ...
        /*  bizim temel amacimiz KamyonRunner'da argument olarak girilen degerin
          Kamyon class'inda intstance variable'a atanmasi. Ancak scope konusunda ogrendigimiz gibi
          ...
          Java bunun icin this keyword'u olusturmustur. Genel kullanim acisindan this keyord'u
