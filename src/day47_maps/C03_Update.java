...
public class C03_Update {
    public static void main(String[] args) {
        ...
        // Map'lerde replace tum value'yu degistirmek istersek kullanilabilir kismi degisikliklerde kullanamayiz
        ReusableMethods.tumValueSiraliYazdir(sinifListMap);
        // Map'i guncelleme yapmak icin key, yenideger'i map'e eklemeliyiz
        // ornegin key 101 icin value Ali, Can, JDev guncelleme icin sinifListMap.put(101,Ali, Can, JavaDeveloper)
        ...
        for (Integer each:keySeti
            ...
            /*  biz key'lerin tamamini aldik herbir key'in value'sunu get'irdik value uzerinde degisikligi yapip
