...
public class C01_IOException {
    public static void main(String[] args) throws FileNotFoundException { // tamam kardes ben bilincindeyim
        /*
          Java'dan bigisayarimizdaki bir dosyaya erismek istiyorsak FileInputStream Class'indan yardim aliriz.
