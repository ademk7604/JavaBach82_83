...
public class Q05_EscapeSequences {
    ...
    Örneğin, sekme, satır başı ve geri alma gibi karakterleri bir çıkış akışına koymak için kaçış dizilerini kullanabilirsiniz.
	  ...
	  \n (or \r): starts from a new line : metni bir alt satirdan itibaren yazdirir.
	          ...
	          \ (bu isareti koduktan sonra istedigin isareti yaz bu sekilde.)
	 \: backslash
	 /:front slash
	 */
            // mulakat sorulari :)
            //  Soru-1 :   konsola   "Hello ", "World  \ //"   seklinde yazdiriniz
            System.out.println("\"Hello \", \"World \\ //\""); // (// bu isaret icin ekstra \ bu isareti kullanmadim)
            ...
            // sonraki "TechProEd ile java cok kolay ..." ifadesi  3 satir sonra ve satir basindan 1 tab ileride
            // yazilsin, hepsini tek kod satırı ile yazdiriniz.
