...
public class Q13_NestedIfandTernary {
...
*/
        int sayi = 8 ;
        String sonuc = ""; // sonradan ilkin hiclige atama yaptik sonra asagida istedigimizi atiyoruz.
        if(sayi>=0 && sayi<=9){
        ...
        }else sonuc="gecersiz"; // sartlarin disindaki else burasi
