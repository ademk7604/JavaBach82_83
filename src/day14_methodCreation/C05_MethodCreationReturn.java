...
public class C05_MethodCreationReturn {
    public static void main(String[] args) {
        ...
        String sehir= sehirAl(); // sehirAll diye bir method olusturup bunu sehir veriable ne atadim
        String tarih= tarihAl(); // tarihAll diye bir method olusturup bunu sehir veriable ne atadim
    ...
    public static String sehirAl() {
        Scanner scan=new Scanner(System.in); //yukaridaki scanner kullanamadigim icin tekrar girdim.
