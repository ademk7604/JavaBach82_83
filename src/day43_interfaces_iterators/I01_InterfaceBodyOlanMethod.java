...
public interface I01_InterfaceBodyOlanMethod {
    void motor();
    public void yakit(); // public gereksiz gordu:)
    public abstract String aku();
    /* normal bir class da oldugumuzu dusunsek iki tane access modifier kullanma ihtimali OLAMAZ
    asagidaki method'da goreceginiz gibi interface'de istisnai olarak body'si olan method'lar olusturulabilir. Bu ozellik Java 8'den
    sonra kullanilmaya baslamistir. Bu ozellikten once, bir interface'e yeni bir method eklememiz gerektiginde
    eskiden beri bu interface'i implement eden tum class'lara gidip yeni eklenen method'u override etmemiz gerekirdi

    bu ozellik sayesinde basina default veya static keyword ekleyerek interface'de yeni ve body'si olan bir method olusturursak
    bu method'un child class'lar tarafindan override edilme MECBURIYETI OLMAZ. ve eskiden implement etmis class'lari degistirmemiz gerekmez
