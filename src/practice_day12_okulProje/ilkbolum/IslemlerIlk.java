package practice_day12_okulProje.ilkbolum;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;
public class IslemlerIlk {
    static List<KisiIlk> ogrtmnList=new ArrayList<>();
    static List<KisiIlk> ogrncList=new ArrayList<>();
    static Scanner scan = new Scanner(System.in);
    static String kisiTuru;
    //static yazmamizin sebebi tum methodlardan ulasamk icin gokteki ay gibi heryeden ulaşılabilsin
    public static void girisPaneli(){
        ...
        String secim=scan.next().toUpperCase();//kucuk harf girse bile buyuk harfe cevirdik cunku kontrol buyuk harfle yapcaz
        switch(secim){
            case "1":
                kisiTuru="OGRENCI";
                islemMenusu();
    ...
    private static void ekle() {//bu method hem ogrenci hem de ogretmen eklemek icin tasarlandi
        ...
        if (kisiTuru.equals("OGRENCI")){//TODO sonra doldur
            ...
            OgretmenIlk ogretmen=new OgretmenIlk(adSoyad,kimliNo,yas,bolum,sicilNo);
